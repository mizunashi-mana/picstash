...
import type { CollectionWithCount } from '@/entities/collection';

export interface CollectionsPageViewProps {
...
export function CollectionsPageView({
  ...
  onCreate,
  onDelete,
}: CollectionsPageViewProps): React.JSX.Element {
  if (isLoading) {
    return (
      <Center h={400}>
        <Loader size="lg" />
    ...
    <Container size="xl" py="md">
      ...
      >
        <Stack>
          ...
          <Group justify="flex-end">
            <Button variant="light" onClick={onCloseCreateModal}>
              キャンセル
            </Button>
            <Button
              onClick={onCreate}
