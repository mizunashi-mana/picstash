...
1. **イラスト管理層**（最優先）
   ...
   - 自作イラストのバージョン管理をしたい絵師
   - 作者・キャラクター・シリーズでの分類ニーズ

2. **同人作品管理層**
   - デジタル同人誌・二次創作のコレクター
   - シリーズ・サークル・イベントでの分類ニーズ
   - アーカイブ一括インポートのニーズ
...
### vs Eagle
- AI 自動タグ付け・説明生成（Eagle は手動のみ）
- クラウド同期オプション（Eagle はローカルのみ）
- 類似画像検索（Eagle は非対応）
...
### vs PhotoPrism / Immich
- カスタム属性システム（多次元の分類が可能）
- イラスト・アート向けの最適化
- 閲覧履歴ベースの推薦機能
