...
| # | セグメント | 提供価値 | 状態 |
|---|-----------|---------|------|
| 6-1 | 閲覧履歴記録 | 閲覧した画像・滞在時間を自動記録できる | 完了 |
| 6-2 | 画像推薦 | 閲覧傾向+ベクトルに基づくおすすめが見れる | 完了 |
| 6-3 | コンバージョン記録 | 推薦クリック・滞在時間を記録し精度向上に活用 | 完了 |
| 6-4 | 統計ダッシュボード | 閲覧傾向・推薦精度を可視化・分析できる | 完了 |

### 検索機能拡充（2セグメント）

| # | セグメント | 提供価値 | 状態 |
|---|-----------|---------|------|
| 7-1 | 検索ワード補完 | 属性・キーワードの入力時に候補が表示される | 完了 |
| 7-2 | 複数条件検索 | AND/OR で複数の検索ワードを組み合わせられる | 完了 |

### 動画対応（3セグメント）

| # | セグメント | 提供価値 | 状態 |
|---|-----------|---------|------|
| 8-1 | 動画アップロード・サムネイル生成 | 動画をライブラリに追加しサムネイルで一覧表示できる | 未着手 |
| 8-2 | 動画再生 | 詳細画面で動画を再生・操作できる | 未着手 |
| 8-3 | 動画 AI 解析 | 動画のキーフレームから属性・説明を自動推薦できる | 未着手 |

### ネイティブアプリ化（3セグメント）

| # | セグメント | 提供価値 | 状態 |
|---|-----------|---------|------|
| 9-1 | ストレージ抽象化 | ローカル/クラウド切り替えの基盤が整う | 未着手 |
| 9-2 | ローカルストレージ対応 | 指定フォルダに画像・DBを保存できる | 未着手 |
| 9-3 | デスクトップアプリ化 | ネイティブアプリとして動作する | 未着手 |
