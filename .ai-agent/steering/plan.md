...
| # | セグメント | 提供価値 | 状態 |
|---|-----------|---------|------|
| 2-1 | 属性ラベル管理 | 属性ラベルを作成・編集・削除できる | 未着手 |
| 2-2 | 画像属性付与 | 画像に属性（ラベル+複数キーワード）を付けられる | 未着手 |
| 2-3 | 画像説明 | 画像に説明文を付けられる | 未着手 |
| 2-4 | 検索 | 属性・説明・キーワードで画像を見つけられる | 未着手 |
...
| 3-2 | 自動属性推薦 | 手動属性付け不要になる | 未着手 |
| 3-3 | 自動説明生成 | 手動で説明を書かなくてよくなる | 未着手 |
| 3-4 | 類似画像検出 | 似た画像をまとめて見れる | 未着手 |
| 3-5 | 重複画像検出 | 重複を整理できる | 未着手 |
...
| # | セグメント | 提供価値 | 状態 |
|---|-----------|---------|------|
| 5-1 | 閲覧履歴記録 | 閲覧した画像・滞在時間を自動記録できる | 未着手 |
| 5-2 | 画像推薦 | 閲覧傾向+ベクトルに基づくおすすめが見れる | 未着手 |
| 5-3 | コンバージョン記録 | 推薦クリック・滞在時間を記録し精度向上に活用 | 未着手 |
| 5-4 | 統計ダッシュボード | 閲覧傾向・推薦精度を可視化・分析できる | 未着手 |

### ネイティブアプリ化（3セグメント）

| # | セグメント | 提供価値 | 状態 |
|---|-----------|---------|------|
| 6-1 | ストレージ抽象化 | ローカル/クラウド切り替えの基盤が整う | 未着手 |
| 6-2 | ローカルストレージ対応 | 指定フォルダに画像・DBを保存できる | 未着手 |
| 6-3 | デスクトップアプリ化 | ネイティブアプリとして動作する | 未着手 |
