...
| 1-2 | Web アプリ組み込み | 既存 Web アプリをレンダラーとして動作 | web-client がアプリ内で動作 | 未着手 |
| 1-3 | ストレージ抽象化 | ローカル/クラウド切り替え可能な基盤 | ストレージアダプタが動作する | 未着手 |
| 1-4 | ローカルストレージ対応 | 指定フォルダに画像・DB を保存 | ローカルフォルダへの保存が動作 | 未着手 |
